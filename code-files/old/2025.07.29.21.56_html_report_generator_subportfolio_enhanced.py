            ...
            scales: {{
                ...
                y: {{
                    ...
                    afterFit: function(scale) {{
                        ...
                        // Let Chart.js calculate natural tick interval, then add two intervals for better spacing
                        // First let Chart.js determine its natural max, then we'll extend it
                        const naturalMax = suggestedMax;
                        
                        // Estimate tick interval Chart.js would use based on the range
                        const estimatedTickInterval = maxTotal <= 10 ? 2 : 
                                                    maxTotal <= 50 ? 5 : 
                                                    maxTotal <= 100 ? 10 : 20;
                        
                        // Add two tick intervals beyond what Chart.js would naturally show
                        scale.max = naturalMax + (2 * estimatedTickInterval);
                    }}
                }}
            }},
            plugins: {{
