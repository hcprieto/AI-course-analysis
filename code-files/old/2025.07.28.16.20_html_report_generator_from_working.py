...
"""
    ...
    def generate_theme_index(self):
        ...
        # Add Outcome Basket analysis as h3 subsection within outcomes (moved down from h2)
        content_html += "<h3>Outcome Basket analysis</h3>\n"
        
        # Add cross-domain summary
        content_html += self.generate_cross_domain_summary()
        
        # Add detailed domain analysis
        content_html += "<h4>Analysis of OB use across Theme's domains of change</h4>\n"
        content_html += self.generate_domain_analysis_from_csv()
        
        # Add custom OBs analysis
        content_html += self.generate_custom_obs_analysis()
        
        # Add geographic distribution as h3 subsection within outcomes (at the end where Chart.js works)
