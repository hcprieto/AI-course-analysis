...
<body>
    <div class="container">
        <div class="header">
            <h1>{title}</h1>
            <div class="current-section" id="currentSection">Overview</div>
        </div>
    ...
    <script>
        ...
        function updateCurrentSection() {{
            const sections = [
                ...
                {{ element: 'h2', text: 'Outcomes gathered', display: 'Outcomes Gathered' }},
                {{ element: 'h3', text: 'Distribution of outcomes across domains of change', display: 'Domain Distribution' }},
                {{ element: 'h3', text: 'Theme-Wide Significance Patterns', display: 'Significance Patterns' }},
                {{ element: 'h3', text: 'Special Cases Analysis', display: 'Special Cases' }},
                {{ element: 'h3', text: 'Geographic Distribution', display: 'Geographic Distribution' }},
                {{ element: 'h2', text: 'Outcome Baskets Analysis', display: 'Outcome Baskets Analysis' }},
                {{ element: 'h3', text: 'Cross-Domain Analysis', display: 'Cross-Domain Analysis' }},
                {{ element: 'h3', text: 'Custom Outcome Baskets', display: 'Custom Outcome Baskets' }}
            ];
            ...
            for (let i = sections.length - 1; i >= 0; i--) {{
                ...
                if (activeSection !== 'Overview') break;
            }}
