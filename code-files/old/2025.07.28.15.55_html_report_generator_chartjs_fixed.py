...
window.addEventListener('load', () => {{
    ...
    // Register the geo controllers if ChartGeo is available
    if (typeof ChartGeo !== 'undefined') {{
        // For chartjs-chart-geo v4, register the controllers directly
        Chart.register(
        ...
        console.error('ChartGeo library not loaded');
        return;
    }}
