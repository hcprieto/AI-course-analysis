            ...
            scales: {{
                ...
                y: {{
                    ...
                    afterFit: function(scale) {{
                        ...
                        // Calculate appropriate tick interval and add one extra line
                        const tickInterval = maxTotal <= 10 ? 2 : 
                                           maxTotal <= 50 ? 5 : 
                                           maxTotal <= 100 ? 10 : 20;
                        
                        // Round up suggestedMax to next tick interval and add one more
                        const roundedMax = Math.ceil(suggestedMax / tickInterval) * tickInterval;
                        scale.max = roundedMax + tickInterval;
                    }}
                }}
            }},
            plugins: {{
